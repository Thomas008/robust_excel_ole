...
1. The ruby shell 'pry' allows, among other useful things, to change the value of 'self' in the console. For example,
...
2. As mentioned above, the RobustExcelOle objects are wrapper of corresponding WIN32OLE objects. The connection between RobustExcelOle and Win32ole was strenghened such that you can convert Win32Ole objects into the corresponding RobustExcelOle object.

  range = sheet.Names.Item("firstcell").to_reo

Likewise, the Win32ole class is being extended such that you can apply RobustExcelOle instance methods to the corresponding Win32ole objects
