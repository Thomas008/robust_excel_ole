...
RobustExcel objects wrap WIN32OLE objects, like workbooks, worksheets and ranges. 
All applicable VBA methods are available for those objects, and are extended by convenient methods for complex tasks.
