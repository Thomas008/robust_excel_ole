...
RobustExcelOle started as a simple fork from tomiacannondale's WrapExcel adapted to Ruby 1.8.6.
The functionality of wrap_excel is optimised and extended by new features.

This is work in progress.

Notice some changes that are not compatible with wrap_excel:
