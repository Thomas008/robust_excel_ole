...
RobustExcel objects wrap WIN32OLE objects, like workbooks, worksheets and ranges. For those objects all VBA methods applying the corresponding VBA object are available, and are extended by convenient methods for more complex tasks.
...
=== More features about creating, opening, saving and closing workbooks 
