...
- unobtrusively opening workbooks, i.e. opening and processing workbooks
  while preserving their status, e.g. read-only mode, saved status
...
You use the command +jreo+ if you want to start the console under jruby and if you don't want to use a version manager to switch between ruby and jruby. The call of the console will include RobustExcelOle for you.
