...
== Current Changes
  ...
  We just want to inform that we dropped the possibility to operate on ranges directly from an Excel instance. However, you can use the method Excel.active_workbook to do so.
  See ChangeLogs.
