...
Save the file, if no file with the same name already exists.
Otherwise proceed acocording to the options.

Options are the following:

[if_exist] :overwrite, :excel, :raise (default)

:overwrite: 

delete the old file and write the new file
