...
This ruby gem helps to automate modifying, reading and writing Excel files.
It supports simultaneously running Excel instances and user interactions.
robust_excel_ole deals with various cases of Excel and user behaviour,
and implements workarounds for some Excel bugs.
The gem provides convenient methods for common tasks, and supports referenced libraries.
It supports Excel 2010 and Excel 2007.

robust_excel_ole works by sending VBA methods via Win32OLE.
