...
We can delete and insert rows and columns.

  table.insert_column(2, "column_name")
  table.delete_column("Enerprise")
  table.insert_row(3)
  table.delete_row(2)

We can also delete only the contents of a row.
...
Similarly we can delete the contents of a column.

  table.delete_column_values(2)

Finally you can delete empty rows
