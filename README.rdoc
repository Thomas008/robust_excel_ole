...
Reusing a running Excel instance, making it visible and turning on displayalerts.
  ...
  excel3 = Excel.new(:reuse => true, :visible => true, :displayalerts => true)

or
  
  excel3 = Excel.current(:visible => true, :displayalerts => true)
