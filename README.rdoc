...
- opening, reading, writing, closing, saving  Excel workbooks 
  reading, writing cells and ranges, naming, adding and copying ranges and worksheets
  convenient methods for standard tasks
- reopening, unobtrusively opening workbooks
- managing simultanously running Excel instances (opening workbooks in various Excel instances)
  supporting handling workbooks across various Excel instances 
- dealing with various cases of Excel and user behaviour:
  managing conflicts when opening workbooks (e.g. blocking or unsaved workbook),
