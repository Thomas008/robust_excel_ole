...
RobustExcelOle supports managing und processing Excel instances and workbooks. It helps controlling Excel. This gem is designed to manage simultaneously running Excel instances,
