...
- dealing with various cases of Excel and user behaviour, e.g. managing conflicts when opening workbooks (e.g. blocking or unsaved workbook),
  even with simultanously happening user interactions
- workarounds for Excel bugs and JRuby bugs
- various workbook formats are supported, e.g. xlsx, xls, xlsm
- library references are supported
