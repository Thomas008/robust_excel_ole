...
This is a simple fork from tomiacannondale's robust_excel_ole adapted to Ruby 1.8.6.


== Description

RobustExcelOle is a to wrap the win32ole, and easy to use Excel operations with ruby.
...
Report issues and feature requests to github Issues. https://github.com/tomiacannondale/robust_excel_ole/issues
