...
RobustExcel objects, like workbooks, worksheets and ranges, wrap the corresponding WIN32OLE objects and are extended by convenient methods for complex tasks.
