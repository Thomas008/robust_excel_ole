...
2. The class Win32Ole is extended such that RobustExcelOle methods can be applied on Win32Ole objects. As mentioned above, the RobustExcelOle objects are wrapper of corresponding WIN32OLE objects. That is, the RobustExcelOle objects and their wrapped Win32Ole objects are interchangeable. One example would be
