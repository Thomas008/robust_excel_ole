...
=== Create and reuse an Excel application.

Create a new Excel.

  excel1 = Excel.create

Return a running Excel application and reuse it.

  excel2 = Excel.current

Reuse a running Excel application, make it visibe and turn on displayalerts.

   excel2 = Excel.new(:reuse => true, :visible => true, displayalerts => true).

Reuse a certain running Excel application.

   excel3 = Excel.new(:excel => excel1)

=== Make Excel visible, invisible
