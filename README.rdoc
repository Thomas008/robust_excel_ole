...
+:if_unsaved+::      +:raise+ (default), +:accept+, +:forget+, +:new_excel+, +:alert+
+:if_obstructed+::   +:raise+ (default), +:forget+, +:save+, +:close_if_saved+, +:new_excel+
+:reuse+::           use an already open Excel instance (default: +true+) 
+:excel+::           an Excel instance (default: +nil+)
