...
You can yield a list all Workbook objects of an Excel instance.

  excel.workbooks

You can access all Workbook objects by using the methods Excel#each_workbook and Excel#each_workbook_with_index.
  
  excel.each_workook

and

  excel.each_workbook.with_index
