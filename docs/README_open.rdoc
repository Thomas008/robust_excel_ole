...
+:readonly_excel+::  Whether some necessary change of the ReadOnly mode of the workbook shall be done in the Excel instance where it was open so far (+true+, default) or in another (already running or new) Excel instance (+false+)
