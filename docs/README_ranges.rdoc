...
You can copy and paste a range by assigning the values using the VBA methods. 
Then you copy the values only. For example, if you have a source range

  src_range = sheet.range(1..2,3..5)

you can copy it to the destination range
...
If you know about the destination range only the left top cell, e.g. [4,6],
then you can use
