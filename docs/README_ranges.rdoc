...
You can (re-) define a name referring to a range by stating its name, and the address. For example, you can define a name for a rectangular range by
...
You can do the same in an worksheet or Excel object.
