...
Similarly you can access a rectangular range by providing the row and column of the top left cell and the row and column of the bottum right cell. Wit VBA methods you use
...
Defining a name referring to a rectangular range is done by stating the row and column of the top left cell and the row and column of the bottom right cell.
